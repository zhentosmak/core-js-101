...
function memoize(func) {
  ...
  memory.set(JSON.stringify(func), func());
  return function getMemory() {
    if (memory.has(JSON.stringify(func))) return memory.get(JSON.stringify(func));
    memory.set(JSON.stringify(func), func());
    return memory.get(JSON.stringify(func));
  };
}
